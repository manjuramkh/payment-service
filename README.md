...
```
java -Dspring.profiles.active=production -jar ./target/payment-service-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.bank/payment-service
```
